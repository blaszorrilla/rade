...
function Filtromuro(turno,datos,id){
    ...
    success:function(datos)
    {
		...
		for (var i = 0; i < jsonData.contenido.length; i++) {
			...
			for (var j = 0; j < resul.datos.length; j++) {
                ...
                "<td class=\"actions\"><a class=\"icon\" title=\"Ver Posteo\" href ="+valor.enlace+" aria-label=\"Left Align\"><span class=\"fa fa-fw fa-file-text\"></span></a>"
