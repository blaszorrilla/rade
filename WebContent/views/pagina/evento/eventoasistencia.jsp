...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" onload="cargar_mas(0)">
  <!-- Navigation-->
         ...
         <tr>
          <th class="visible-md visible-lg visible-sm">T&iacutetulo</th>
			                ...
			                <th class="textoderecha">Ubicaci&oacuten</th>
			                 <th class="textoderecha">Cantidad de Asistencia</th>  			                
			                <th class="textoderecha">Eliminar</th>
    					...
    					for (var j = 0; j < resul.datos.length; j++) {
    						var valor = resul.datos[j];
    						 var nuevaFila="<tr>"; 
    			                ...
    			                nuevaFila+="<td>"+valor.asistencia+"</td>";
    			                nuevaFila+="<td class=\"textoderecha\">" +
    			                "<class=\"actions\"><button class=\"icon\" title=\"Eliminar Evento\" onclick=\"bajaasistenciaevento("+valor.codigo_asistencia+")\"   aria-label=\"Left Align\"><span class=\"fa fa-fw fa-trash-o  \"></span></button>" +
    				            "</td>"; 
    			                nuevaFila+="</tr>";
