...
<ul class="text hidden">
  ...
  <li class="ghost"><a>o</a></li>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
			...
			<!-- <h5>General</h5> -->
			   ...
			   <li class="nav-item">
					<a class="nav-link activo" href="/rade/evento">
						...
						<span class="nav-link-text">Nuevo Evento</span>
					</a>
				</li>
	  ...
	  <table class="table table-striped" id="tablaevento">
		 ...
		 <thead>
         <tr>
          <th class="visible-md visible-lg visible-sm">T&iacutetulo</th>
    					...
    					for (var j = 0; j < resul.datos.length; j++) {
    						var valor = resul.datos[j];
    						 var nuevaFila="<tr>"; 
    			                ...
    			                "<td class=\"actions\"><a class=\"icon\" title=\"Ver Evento\" href ="+valor.enlace+" aria-label=\"Left Align\"><span class=\"fa fa-fw fa-file-text\"></span></button>"+ 
    			                "<td class=\"actions\"><button class=\"icon\" title=\"Asistir Evento\"  onclick=\"Asistenciaevento("+valor.codigo+")\" aria-label=\"Left Align\"><span class=\"fa fa-fw fa-check \"></span></button>"+
    				            "</td>"; 
    			                nuevaFila+="</tr>";
    			                
    						/*  nuevaFila+= "<p class=\"textoderecha\">"+valor.tema+"</p>";
    						 nuevaFila+= "<p class=\"visible-md visible-lg\">"+valor.fecha+"</p>";
    						 nuevaFila+=  "<p class=\"textoderecha\">"+valor.hora+"</p>";
    		                nuevaFila+="<p class=\"textoderecha\"></p>" ;*/
    		               /* "<button class=\"actions\"><a class=\"icon\" title=\"Ver Posteo\" href ="+valor.enlace+" aria-label=\"Left Align\"><span class=\"fa fa-fw fa-file-text\"></span></button>"+ 
    		                "<button class=\"actions\"><button class=\"icon\" title=\"Modificar Posteo\" onclick=\"mod()\" aria-label=\"Left Align\"><span class=\"fa fa-fw fa-gear \"></span></button>"+ 
    		                "<button class=\"actions\"><button class=\"icon\" title=\"Eliminar Posteo\" onclick=\"borrar("+valor.codigo+")\"   aria-label=\"Left Align\"><span class=\"fa fa-fw fa-trash-o  \"></span></button>" +*/
  ...
  <script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/js/evento2.js"></script> 
