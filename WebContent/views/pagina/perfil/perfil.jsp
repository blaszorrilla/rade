...
<!--------------------------------------------------INICIO NAV-------------------------------------------------->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
  					<div class="logo">
						<a><img src="<%out.println(request.getContextPath()); %>/views/images/logo.png" alt=""></a>
					</div>
<!--------------------------------------------------INICIO RADE EXP-------------------------------------------------->
<div class="exp">
        		...
        		<div class="card-header" id="datosPerfil">
          		...
          		<div class="card-body colorP">
								...
								<p>
									...
									<h6 class="titu">Dirección:</h6><h6 class="h6"><% out.print(direccion); %></h6>
									<h6 class="titu">Teléfono:</h6><h6 class="h6"><% out.print(telefono); %></h6>
									<h6 class="titu">E-mail:</h6><h6 class="h6"><% out.print(email); %></h6>
									<h6 class="titu">Página:</h6><h6 class="h6"><% out.print(pagina); %></h6>
								...
								<img class="imagen" src="<%out.println(request.getContextPath()); %>/views/images/utic.jpg" alt="">
									...
									<h6 class="titu">Nombre:</h6><h6 class="h6"><% out.print(nombre);%></h6>
								...
								<p>
									...
									<h6 class="titu">Institución:</h6><h6 class="h6"><% out.print(institucion); %></h6>
									<%-- <h6 class="titu">sede:</h6><h6 class="h6"><% out.print(sede); %></h6> --%>
    		...
    		<div class="card mb-3" id="camdat">
        		<div class="card-header" id="cambiodate">
          			...
          			<div class="card-body colorP">
          				...
          				<input class="form-control" value="<%out.print(nombre);%>" id="ceonombre">
          				<br>
          				<h6 class="titu">Apellido:</h6>
          				<input class="form-control" value="<%out.print(apellido);%>" id="ceoapellido">
          				<br>
          				<h6 class="titu">Dirección:</h6>
          				<input class="form-control" value="<%out.print(direccion);%>" id="ceodireccion">
          				<br>
          				<h6 class="titu">Teléfono:</h6>
          				<input class="form-control" value="<%out.print(telefono);%>" id="ceotelefono">
          				<br>
          				<h6 class="titu">Página:</h6>
          				<input class="form-control" value="<%out.print(pagina);%>" id="ceopagina">
          				<br>
          				
          				<%-- <h6 class="titu">Institucion:</h6>
          				<select class="form-control" id="insticeo">
						...
						%>
          				...
          				<br> --%>
          				<div >
          						<button class="btn btn-success" type="button" id="guardardatosceo">Guardar</button>
          						<button class="btn btn-danger" type="button" id="cancelceo">Cancelar</button>
          					</div>
          				</div>
          				<!-- ////////////////////////////////////////////////////////////////////////////////////////// -->
          				<div id="insticonfi">
          				<h6 class="titu">Nombre:</h6>
          				<input class="form-control" value="<%out.print(nombre);%>" id="instinombre">
          				<br>
          				<h6 class="titu">Dirección:</h6>
          				<input class="form-control" value="<%out.print(direccion);%>" id="instidireccion">
          				<br>
          				<h6 class="titu">Teléfono:</h6>
          				<input class="form-control" value="<%out.print(telefono);%>" id="institelefono">
          				<br>
          				<div>
          						<button class="btn btn-success" type="button" id="guardardatosinsti">Guardar</button>
						...
						%>
          				...
          				<div>
          						...
          						<button class="btn btn-danger" type="button" id="cancelperfil">Cancelar</button>
          					</div>
          				</div>
          					<!-- ////////////////////////////////////////////////////////////////////////////////////////// -->
          			</div>
    		...
    		<div class="card mb-3" id="fotocam">
        		<div class="card-header" id="camfoto">
          		...
          		<br>
          			...
          			<button class="btn btn-primary" type="button">Cambiar</button>
     ...
     <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Proyecto RADE: Recurso Académico Digital Específico ©</small>
        </div>
      </div>
    </footer> 
