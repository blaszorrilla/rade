...
<body class="fixed-nav sticky-footer bg-light" id="page-top" onload="BuscarSolicitud('primero',<% out.print(id); %>);">
  <!-- Navigation-->
      ...
      <ul class="navbar-nav ml-auto">
     		 ...
     		 <li class="nav-item dropdown">
							...
							<li class="nav-item dropdown">
								...
								<ul>
									<li><a href="#" title=""><span class="fa fa-fw fa-user"></span> Perfil del usuario</a></li>
								</ul>
							</li>
    ...
    <div class="container-fluid">
      ...
      <div class="main-section-data">
          ...
          <!--   ------------------------------------------------------------------------------------------------------------------ -->
        	<!-- INICIO SOLICITUD -->
        		...
        		<div class="form-group input-group">
                 ...
                 <button class="btn btn-success btn-circle" type="button" onclick="BuscarSolicitud('primero');"><i class="fa fa-search"></i></button>
        ...
        <div class="row content-list-head">
	        ...
	        <!-- Inicio Tabla -->
	    <table class="table table-striped" id="tablaSolicitud">
	    
		 <thead>
         <tr>
          <th class="visible-md visible-lg visible-sm">T&iacutetulo</th>
			                <th class="textoderecha">Tema</th>
			                <th class="visible-md visible-lg">Fecha</th>
			                <th class="textoderecha">Hora</th>    
         </tr>
         </thead>
        <tbody>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/views/js/posteosmio.js"></script>  
<script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/js/jquery.min.js"></script>
<script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/js/popper.js"></script>
<script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/js/bootstrap.min.js"></script>
<!--  -->
<script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/js/jquery.range-min.js"></script>
<script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/lib/slick/slick.min.js"></script>
<script type="text/javascript" src="<%out.println(request.getContextPath()); %>/views/js/script.js"></script>
<!--  -->
