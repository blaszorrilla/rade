...
try{
	...
	desdeenlace=proceso.FiltroGeneralString("SELECT  `enlace_posteo`.`id_posteo` FROM `enlace_posteo` "
	...
	System.err.print("fdsfds "+idposteo);
	cargar=proceso.FiltroGeneralString("SELECT posteo.titulo,posteo.texto,DATE_FORMAT(posteo.fecha,'%d %b %Y'),"
			+"DATE_FORMAT(posteo.fecha,'%H:%i:%s'),perfil.usuario,tipo_perfil.nombre "
			+"FROM posteo LEFT JOIN perfil ON posteo.id_prefil=perfil.id_prefil LEFT JOIN tipo_perfil ON perfil.id_tipo_perfil=tipo_perfil.id_tipo_perfil WHERE posteo.id_posteo="+idposteo,"6","trayendo todo");
...
try{
	System.err.print("comentario "+idposteo);
	comentarios=proceso.FiltroGeneralString("SELECT pe.usuario,DATE_FORMAT(pc.fecha, '%d %b %Y' ' a las '  '%H:%i:%s'),pc.texto,pc.id_posteo_comentario FROM posteo_comentario pc INNER JOIN perfil pe ON pe.id_prefil=pc.id_prefil WHERE pc.estado='ACTIVO' AND  pc.id_posteo="+idposteo, "4", "busca comentario");
}catch(Exception e){
...
<!--------------------------------------------------FIN HEAD-------------------------------------------------->
<body class="fixed-nav sticky-footer bg-dark" id="page-top" onload="cargar_comentarios('0');">
<!--------------------------------------------------INICIO NAV-------------------------------------------------->
...
<!--------------------------------------- INICIO POSTEO ----------------------------------------------------------->
    <a class="btn btn-link"  href="/rade/posteo">Volver</a>	
  	...
  	<!-- INICIO VER MI POSTEO -->
	    ...
	    <table id="tablaPosteo">
            ...
            <!-- FIN DE TABLA -->
				    ...
				    <p><img src="cargar.gif">Cargando...</p>
				</div>
			...
			<!-- FIN VER MI POSTEO -->  
                ...
                <%--   <input type="hidden" id="id_perfil" value="<% out.print(id_perfil); %>"> --%>
                 <button class="btn btn-success btn-circle" type="button"  id="busquedaTodoposteo" onclick="cargartotsposteo('0');"><i class="fa fa-search"></i></button>                          
			        ...
			        <div class="posteo table-responsive" id="divposteomuro">
			   <!-- Inicio Tabla -->
	    <!--  <table id="tablaposteomuro">
            ...
            <!-- FIN DE TABLA -->
					...
					<div class="ajax-load text-center">
				    <p><img src="views/images/cargar.gif">Cargando...</p>
				</div>
				<div class="fin text-center" style="display: none;">
				    <!-- Fin de scroll	-->    
				</div>
  ...
  <form>
    ...
    <label class="radio-inline">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary float-right" id="guardar" onclick="guarda_puntaje_posteo();"    data-dismiss="modal">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<!-- COMENTARIOS -->
			<div class="card mb-3" id="divcomentario">
    <div class="content-wrapper">
    <div class="container-fluid">
                   ...
                   <div class="container">               
 						  ...
 						  <div class="form-group"> </div>
                            ...
                            for(int i=0;i<cargar.size();i++){
                        		 ...
                        		 out.print("<small><p><strong>"+cargar.get(i).get(4)+"</strong><em> Publicado el "+cargar.get(i).get(2)+" a las "+cargar.get(i).get(3)+"</em></p></small><div class=\"well\"><center><h5><b>"+cargar.get(i).get(0)+"</b></h5></center><p>"+cargar.get(i).get(1)+"</p></div>"); 
                            }
                            %> 	
		...
		<div class="col-lg-9">
			<div class="post-bar">
                   <div class="container">               
 						  ...
 						  <div class="posteo" id="divcarga_comentario">
 						  </div>
 						...
 						<div class="form-group">
  							...
  							<div> 	
    				 				<div class="form-group" >
                            				...
                            				<div class="form-group">	
                                  				<button type="button" class="btn btn-primary float-right float-right" onclick="guardarcomentario()">Enviar</button>
